...
| Skill | Description |
| ----- | ----------- |
| full-ai-stack | Provide instructions to install and configure ai-stack |
...
```bash
node scripts/add-skill.js full-ai-stack "Provide instructions to install and configure ai-stack"
```
